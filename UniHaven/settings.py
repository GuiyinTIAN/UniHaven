...
SECRET_KEY = "django-insecure-#)5-5hiy-y-lc!(oop+i5#(7(!s*zb#ve(=jfv0a)e(+_+!s+y"
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "django.template.context_processors.i18n",  # 确保此行已添加
            ],
        },
    },
]
...
# Email backend (for testing with console output)
